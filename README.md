...
| 路径 | 内容 |
|------|------|
| [`生活小助手小程序/`](./生活小助手小程序/) | 小程序源码 + 功能简介大纲（产品亮点 · 四级功能结构 · 技术栈 · 迭代记录）。**主说明文档 / 面试展示入口**。 |
| [`文档/`](./文档/) | 配套资料：使用说明书（docx）、功能清单（docx）、文档生成脚本 `generate_doc.py`、小程序自动化测试脚本、开发部署指南。 |
...
2. 选择「导入项目」，目录选 `生活小助手小程序/`，AppID 用「测试号」或你的 AppID；
3. 功能详解见 [`生活小助手小程序/README.md`](./生活小助手小程序/README.md)，部署与配置见 [`文档/`](./文档/)。
